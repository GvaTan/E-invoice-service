...
//		发票分组
	...
	public int countInvoiced(String docNum) { 
		List<InvoiceSplitLine>  list =invoiceSplitLineMapper.countInvoiced(docNum);
		if(list==null) {
			return 0;
		}else {
			return list.size();
